...
class _LandingScreenState extends State<LandingScreen>
  ...
  bool isClearPress = false;
  var appModeBox = Hive.box('appModeBox');
  String? userID;
  AuthUser? authUser = AuthService().getUser();
  final InAppPurchase _connection = InAppPurchase.instance;
  TextEditingController searchController = TextEditingController();
  List<String> _kProductIdSubscription = <String>['com.ekamra.ott.allaccess'];
  ...
  void _handleChanges(String value) {
    if (value.isEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
        ...
        onPointerDown: (_) {
          if (isClearPress && searchController.text.isNotEmpty) {
            activeSearch = true;
            isClearPress = false;
          } else {
  ...
  Widget _renderAppBar() {
    return AppBar(
      iconTheme: IconThemeData(
        color:
            isDark ? CustomTheme.primaryColorRed : CustomTheme.primaryColorDark,
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Icon(Icons.clear, color: CustomTheme.whiteColor),
          ),
        ],
      ),
    );
                  ...
                  showDialog(
                      ...
                      builder: (dialogContext) {
                        return AlertDialog(
                          ...
                          actionsPadding:
                              EdgeInsets.only(right: 15.0, bottom: 15),
                          actions: <Widget>[
                            GestureDetector(
                                onTap: () async {
                                  await _auth.signOut();
